        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            <div className="flex justify-start lg:w-0 lg:flex-1">
              <span className="text-2xl font-bold text-indigo-600">MatchMaker</span>
            </div>
      ...
      <main>
        <div className="relative overflow-hidden">
              ...
              <div className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left">
                  <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    <span className="block xl:inline">Connect with the</span>{' '}
                    <span className="block text-indigo-600 xl:inline">perfect match</span>
                  </h1>
                  <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                    AI-powered platform that intelligently matches employers with the perfect helpers. 
                    Whether you&apos;re looking for skilled professionals or seeking opportunities, 
                    our advanced matching algorithm ensures the best fit for everyone.
                  </p>
          ...
          <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <div className="h-56 w-full bg-gradient-to-r from-indigo-500 to-blue-600 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
              <div className="text-white text-center">
                ...
                <p className="text-lg opacity-90">Smart connections for better outcomes</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                <div className="relative">
                  ...
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Our advanced AI analyzes profiles and preferences to create perfect matches.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Multiple User Types</p>
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Support for employers, agencies, and individual helpers with tailored experiences.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Built with security in mind using Firebase authentication and secure data handling.
                  </p>
                </div>
              </div>
            </div>
